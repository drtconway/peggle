...
describe("elementry rules", () => {
  ...
  it("simple rule 1", () => {
    ...
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"literal","value":"A"}}]';
  ...
  it("simple rule 2", () => {
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"name","value":"bar baz"}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
  it("simple rule 3", () => {
    const s = "<foo> ::= <bar baz>...";
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"plus","value":{"kind":"name","value":"bar baz"}}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
  it("simple rule 4", () => {
    const s = "<foo> ::= <bar> <baz>";
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"conj","value":[{"kind":"name","value":"bar"},{"kind":"name","value":"baz"}]}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
  it("simple rule 5", () => {
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"disj","value":[{"kind":"conj","value":[{"kind":"name","value":"bar"},{"kind":"name","value":"baz"}]},{"kind":"name","value":"qux"}]}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
  it("simple rule 6", () => {
    const s = "<foo> ::= <bar> | <baz> <qux>";
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"disj","value":[{"kind":"name","value":"bar"},{"kind":"conj","value":[{"kind":"name","value":"baz"},{"kind":"name","value":"qux"}]}]}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
  it("simple rule 7", () => {
    const s = "<foo> ::= [ <baz> <qux> ]";
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"opt","value":{"kind":"conj","value":[{"kind":"name","value":"baz"},{"kind":"name","value":"qux"}]}}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
  it("simple rule 8", () => {
    ...
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp =
      '[{"kind":"definition","name":"foo","body":{"kind":"conj","value":[{"kind":"opt","value":{"kind":"conj","value":[{"kind":"name","value":"baz"},{"kind":"name","value":"qux"}]}},{"kind":"name","value":"bar"},{"kind":"name","value":"foo"}]}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
});
...
describe("some examples from the SQL grammar", () => {
  ...
  it("character string literal (1)", () => {
    ...
    let stk: B.Node[] = [];
    expect(p.accept(B.grammar.rules.declaration, s, stk)).to.eql(true);
    let exp = '[{"kind":"definition","name":"character string literal","body":{"kind":"conj","value":[{"kind":"opt","value":{"kind":"conj","value":[{"kind":"name","value":"introducer"},{"kind":"name","value":"character set specification"}]}},{"kind":"name","value":"quote"},{"kind":"opt","value":{"kind":"plus","value":{"kind":"name","value":"character representation"}}},{"kind":"name","value":"quote"},{"kind":"opt","value":{"kind":"plus","value":{"kind":"conj","value":[{"kind":"name","value":"separator"},{"kind":"name","value":"quote"},{"kind":"opt","value":{"kind":"plus","value":{"kind":"name","value":"character representation"}}},{"kind":"name","value":"quote"}]}}}]}}]';
    expect(JSON.stringify(stk)).to.eql(exp);
  });
...
function generateRule(name: string, rules: {[name: string]: B.Node}, lines: string[]) {
  let body = rules[name];
  if (!body) {
    return;
  }
...
describe("parse all the regular productions from the SQL grammar", () => {
    const text = fs.readFileSync(path.join(__dirname, 'data/sqlite.bnf'), 'ascii');
    const groups = text.split(/\r?\n\r?\n/);
    let p = new P.Parser(B.grammar);
    let defns : {[name: string]: B.ExpressionNode} = {};
    groups.forEach((txt, idx) => {
        ...
        if (node.kind == "definition") {
            defns[node.name] = node.body;
            return;
        }
        console.log(defns);
    });
    let S = new B.Syntax(defns);
    console.log(JSON.stringify(S.missingRules()));
});